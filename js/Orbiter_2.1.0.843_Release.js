...
net.user1.orbiter.Product.clientVersion  = new net.user1.orbiter.VersionNumber(2,1,0,843);
...
net.user1.orbiter.Orbiter.prototype.configLoadCompleteListener = function (request) {
  ...
  try {
    ...
    var autoreconnectfrequency = this.getTextForNode(config, "autoReconnectFrequency"); 
    if (autoreconnectfrequency != null) {
      this.connectionMonitor.setAutoReconnectFrequency(parseInt(autoreconnectfrequency));
    }
